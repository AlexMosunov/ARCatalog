...
class FocusSquare: SCNNode {
    ...
    static let size: Float = 0.27
    
    // Thickness of the focus square lines in meters.
    static let thickness: Float = 0.028
    ...
    static let sideLengthForOpenSegments: CGFloat = 0.3
    
    // Duration of the open/close animation
    static let animationDuration = 1.5
    
    static let primaryColor = #colorLiteral(red: 0.3176470697, green: 0.07450980693, blue: 0.02745098062, alpha: 1)
    
    // Color of the focus square fill.
    static let fillColor = #colorLiteral(red: 0.1960784346, green: 0.3411764801, blue: 0.1019607857, alpha: 1)
